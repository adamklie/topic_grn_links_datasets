...
# Save the raw object
print("Saving preprocessed object...")
seurat_obj$celltypes <- seurat_obj$orig.ident
saveRDS(seurat_obj, file.path(OUT_DIR, "normalized.rds"))

# Grab the normalized data
norm.mat <- seurat_obj@assays$RNA@data

# Save as tsv
print("Saving normalized tsv...")
